//! Build script for cargo-operai.
//!
//! Reads the operai and operai-build versions from the Cargo.toml and exposes
//! them as environment variables for use in the template generation code.
...
fn main() {
    ...
    // Read the workspace Cargo.toml to get dependency versions
